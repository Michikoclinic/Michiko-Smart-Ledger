...
function render(){
 ...
 const t=totals(); const daily=t.cash+t.scb+t.lp+t.cardKbank+t.cardBbl+t.cardKtc; const customerCount=new Set(rows.map(row=>normalizedHn(row.hn)).filter(Boolean)).size;
