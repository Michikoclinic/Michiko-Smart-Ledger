...
function renderDetailContent(line){return esc(formatNumbersInText(line)).replaceAll("หักจากมัดจำ",'<strong class="deposit-deduction-text">หักจากมัดจำ</strong>').replaceAll("ค้างชำระ",'<strong class="outstanding-text">ค้างชำระ</strong>')}
