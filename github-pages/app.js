...
function resetCashReceiptForm(){cashReceiptForm.reset();pendingCashReceipt=null;editingCashReceiptKey="";confirmCashReceipt.checked=false;saveCashReceiptPermanent.disabled=true;document.querySelector("#cashReceiptFormTitle").textContent="เพิ่มรายการรับเงินสด";document.querySelector("#cashReceiptFormHelper").textContent="ลายเซ็นยังไม่ต้องเซ็นตอนนี้ หลังบันทึกให้กดช่องลายเซ็นของรายการนั้นเพื่อเซ็นรับภายหลัง"}
