globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-DVnOn8X0.js","assets/layout-segment-context-CGf_Z2uh.js"];
...
function getDraftSecret() {
	return "d854cbe9-67c6-477f-9ba1-bf8792c77b97";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "df1e3173-eba8-4b34-b842-53743c20902d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "df1e3173-eba8-4b34-b842-53743c20902d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "df1e3173-eba8-4b34-b842-53743c20902d",
		rootBoundaryId
	});
}
/**
